    ...
    public sealed class SqlHelper
    {
        ...
        private static void PrepareCommand(SqlCommand command, SqlConnection connection, SqlTransaction transaction, CommandType commandType, string commandText, SqlParameter[] commandParameters, out bool mustCloseConnection)
        {
            ...
            if (connection.State != ConnectionState.Open)
            {
                ...
                {
                    string message = "Database connection Error! Maybe your Database is not runing or database connection string is mistake?";
        ...
        public static DataSet FillDatasetUsingReader(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            DataSet dataSet = new DataSet();
                ...
                using (SqlCommand cmd = new SqlCommand(commandText, con))
                {
                    ...
                    using (SqlDataReader reader = cmd.ExecuteReader())
                    {
                        ...
                        while (!reader.IsClosed)
                        {
                            if (reader.HasRows)
                            {
                                dataSet.Tables.Add("Table" + loopcount.ToString());
                                dataSet.Tables[loopcount].Load(reader);
                                loopcount++;
                            }
                        }
                    }
